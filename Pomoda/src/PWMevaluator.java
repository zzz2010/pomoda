        ...
        SearchThread.recordSiteThreshold=Double.POSITIVE_INFINITY;
        	 ...
        	 while(iter.hasNext())
        	 {
        		 ...
        		 if(lastseq!=currloc.getSeqId())
        		 {
        			 ...
        			 if(lastseq!=-1)
        			 {
        				 Sorted_labels.put(maxseq_score-(rand.nextDouble()-0.5)*common.DoubleMinNormal, 1);
        	...
        	maxseq_score=Double.NEGATIVE_INFINITY;
	       	 while(iter.hasNext())
	    	 {
	    		 ...
	    		 if(lastseq!=currloc.getSeqId())
	    		 {
	    			 ...
	    			 if(lastseq!=-1)
	    			 {
	    			 Sorted_labels.put(maxseq_score+(rand.nextDouble()-0.5)*common.DoubleMinNormal, 0);
